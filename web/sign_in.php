...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . "/important/function.php"); ?>
  ...
  <link rel="icon" href="/yts/img/favicon-vfldLzJxy.ico" type="image/x-icon">
	...
	<link id="css-583125701" rel="stylesheet" href="/yts/cssbin/www-the-rest-vflzYVqky.css">	
	 <script src='/important/ajax/signin_script.js'></script>
...
<style type="text/css">
  ...
  <div class="wrapper">
  <?php require_once("yts/modbin/header.php"); ?>
...
<div class="email-div">
  <label for="username"><strong style="margin-bottom: 10px;" class="yt-uix-form-label">Username</strong></label>
...
<div class="passwd-div">
  <label for="Passwd"><strong style="margin-bottom: 10px;" class="yt-uix-form-label">Password</strong></label>
  <input class="yt-uix-form-input-text" style="width: 270px; height: 15px;" type="password" name="Passwd" id="Passwd">
</div>
  <input type="button" class="yt-uix-button yt-uix-button-hh-primary" onclick="signin_Validator()" name="signIn" id="signIn" value="Sign in">
  <label class="remember">
  <input class="yt-uix-form-input-checkbox" type="checkbox" name="rememberMe" id="rememberMe">
...
<div class="product-headers">
  ...
  <ul class="features">
  <li>
  <img alt="" src="/yts/img/ytfav.png">
  <p class="title">
  Keep up with your favorite channels
  </p>
  <p>
  You can subscribe to channels and put videos in playlists.
  </p>
  </li>
  <li>
  <img alt="" src="/yts/img/ytonzgo.png">
  <p class="title">
  Watch almost everywhere
  </p>
  <p>
  Maybe I will make an Android app, but you can watch videos on a PC.
  </p>
  </li>
  <li>
  <img alt="" src="/yts/img/ytwfrnz.png">
  <p class="title">
  Share with your friends
  </p>
  <p>
  You can share videos with your friends in Discord.
  </p>
  </li>
</ul>
