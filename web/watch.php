<?php 
	...
	$initvid->add_views($_GET['v'], $_COOKIE['sessionuser']); 
   ...
   <p class="yt">
      ...
      <button class="yt-uix-button yt-uix-button-hh-default yt-uix-button-empty" onclick=";return false;" type="button" id="watch-video-info-reset"  role="button"><span class="yt-uix-button-content">Cancel </span></button>
								...
								<div id="watch7-discussion">
									...
									<?php } else {?>			
<form class="comments-post has-focus" method="post" onsubmit="if (_gel('comment-box').value == '') return false;" action="/r/comment_servlet?add_comment=1" data-initialized="true">
...
<textarea id="comment-box" placeholder="Share your thoughts..." class="yt-uix-form-input-textarea comments-textarea link-gplus-lightbox" onfocus="yt.www.comments.initForm(this, false, false);" data-upsell="comment" name="comment"></textarea>
</div> 
...
<script>
yt.setConfig({
      'PLAYER_CONFIG': {"min_version": "8.0.0", "html5": false, "url": "/yts/swfbin/watch_as3_hh-vflVnPS9m.swf", "attrs": {"id": "video-player", "width": "100%", "height": "100%"}, "params": {"allowscriptaccess": "always", "allowfullscreen": "true", "bgcolor": "#000000"}, "args": {"ptk": "youtube_multi", "allow_embed": 1, "vq": "auto", "autohide": "1", "video_wall": 1, "endscreen_module": "/yts/swfbin/endscreen-vflpYXlXL.swf", "allow_ratings": 1, "length_seconds": 255, "is_html5_mobile_device": false, "rel": "1", "hl": "en_US", "title": "<?php echo $video_info['vtitle']; ?>", "no_afv_instream": "1", "shortform": true, "inactive_skippable_threshold": 600000, "rvs": "<?php include_once('get_endscreen_info.php'); ?>", "iurl": "<?php echo 'http://jark.succulent64.ml/ytd/thumb/' . $_GET['v'] . '.png'; ?>", "fexp": "914501,910020,916806,914083,916612,922401,920704,912806,927201,922403,925003,913546,913556,916805,920201,901451", "hl": "bg_BG", "is_html5_mobile_device": false, "video_id": "<?php echo $_GET['v']; ?>", "iv_read_url": "http://web.archive.org/web/20121224011805if_/http://www.youtube.com/annotations_iv/read2?channel_id=UC--J8oemuh9V7iAzZz5CnBA&feat=CS&sparams=channel_id%2Cexpire%2Cvideo_id&signature=80C373CD6C6EB0171F4B8559A197B325C08B404E.6651AE55E00B402B760F9FF49DCCAB346DE98429&expire=1356355500&key=a1&video_id=KHLqyyhSsjo&length_ms=421000", "enablejsapi": "1", "sendtmp": "1"}, "url_v9as2": "/yts/swfbin/cps-vfloZzTd_.swf", "url_v8": "/yts/swfbin/player2.swf", "assets": {"html": "\/html5_player_template", "css_actions": "/yts/cssbin/www-player-actions-vflBv1HfX.css", "js": "/yts/jsbin/html5player-vflppn5jI.js", "css": "/yts/cssbin/www-player-vfl95jqbw.css"}},
  ...
  yt.setMsg('PLAYER_FALLBACK', "\u003cdiv class=\"yt-alert yt-alert-default yt-alert-error  yt-alert-player\"\u003e  \u003cdiv class=\"yt-alert-icon\"\u003e\n    \u003cimg s\u0072c=\"\/\/s.ytimg.com\/yts\/img\/pixel-vfl3z5WfW.gif\" class=\"icon master-sprite\" alt=\"Alert icon\"\u003e\n  \u003c\/div\u003e\n\u003cdiv class=\"yt-alert-buttons\"\u003e\u003c\/div\u003e\u003cdiv class=\"yt-alert-content\" role=\"alert\"\u003e    \u003cspan class=\"yt-alert-vertical-trick\"\u003e\u003c\/span\u003e\n    \u003cdiv class=\"yt-alert-message\"\u003e\n            Adobe Flash Player or an HTML5 supported browser is required for video playback. \u003cbr\u003e \u003ca href=\"http:\/\/www.oldversion.com\/windows\/macromedia-flash-player\/\"\u003eGet Adobe Flash Player\u003c\/a\u003e \u003cbr\u003e \u003ca href=\"\/html5\"\u003eLearn more about upgrading to an HTML5 browser\u003c\/a\u003e\n    \u003c\/div\u003e\n\u003c\/div\u003e\u003c\/div\u003e");
