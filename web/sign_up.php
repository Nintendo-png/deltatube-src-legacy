...
<div class="signin-box">
  <h2>Sign up</h2>
  <form novalidate id="gaia_loginform" method="post">
<div class="email-div">
  <label for="username"><strong style="margin-bottom: 10px;" class="yt-uix-form-label">Choose a JarkTube username</strong></label>
  <input type="text" style="width: 270px; height: 15px;" class="yt-uix-form-input-text" spellcheck="false" name="username" id="username" value="">
  <small>Your email and username are unique to you and no one else can take it</small>
</div>
<div class="passwd-div">
  <label for="Passwd"><strong style="margin-bottom: 10px;" class="yt-uix-form-label">Create a Password</strong></label>
  <input class="yt-uix-form-input-text" style="width: 270px; height: 15px;" type="password" name="pass" id="pass">
   <div class="password-meter-wrap">
            <div id="password-meter-bar" class="password-meter-bar"></div>
        </div>
</div>
<div class="passwd-div">
  <label for="Passwd"><strong style="margin-bottom: 10px;" class="yt-uix-form-label">Confirm your Password</strong></label>
  <input class="yt-uix-form-input-text" style="width: 270px; height: 15px;" type="password" name="Passwd-2" id="Passwd-2">
</div>
<div class="email-div">
  <label for="email"><strong style="margin-bottom: 10px;" class="yt-uix-form-label">Email</strong></label>
  <input type="email" style="width: 270px; height: 15px;" class="yt-uix-form-input-text" spellcheck="false" name="email" id="email" value="">
  <small>Email Verification system coming soon. Once email is used, cannot be used again.</small>
</div>
  <input type="button" class="yt-uix-button yt-uix-button-hh-primary" onclick="signup_Validator()" name="signup" id="signup" value="Sign up">
...
<div class="product-headers">
  <h2>Create an JarkTube account</h2>
</div>
  
<p>Create a JarkTube account to use JarkTube's user features like uploading.</p>
  </div>
  </div>
