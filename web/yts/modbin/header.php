...
<div id="yt-masthead-container" class="yt-grid-box yt-masthead-hh">
			<div id="yt-masthead" class="">
				<a id="logo-container" href="/" title="JarkTube home"><img id="logo" src="/yts/img/pixel-vfl3z5WfW.gif" alt="JarkTube home"></a>
  ...
  <span id="yt-masthead-dropdown" onclick="yt.www.masthead.toggleExpandedMasthead();"></span>
				...
				<?php } ?>
				<div id="yt-masthead-content"><span <?php if(isset($_COOKIE['sessionuser'])) { ?>class="yt-uix-button-group"<?php } ?> id="masthead-upload-button-group"><a href="/my_videos_upload" class="yt-uix-button  start link-gplus-lightbox yt-uix-sessionlink yt-uix-button-hh-default" data-sessionlink="ei=i5MVUYPRKOnziQLqoYDACg" data-upsell="upload"><span class="yt-uix-button-content">Upload</span></a><?php if(isset($_COOKIE['sessionuser'])) { ?><button onclick=";return false;" type="button" class="end yt-uix-button yt-uix-button-hh-default yt-uix-button-empty" data-button-menu-id="upload-button-menu" role="button"><img class="yt-uix-button-arrow" src="//s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" alt=""></button><?php } ?></span>
				<ul id="upload-button-menu" class="yt-uix-button-menu yt-uix-button-menu-default" role="menu" aria-haspopup="true" style="display: none"><li role="menuitem"><a href="/my_videos" class="yt-uix-button-menu-item upload-menu-link"><img class="upload-menu-vm" src="//s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif">Video Manager</a></li><li role="menuitem"><a href="/analytics" class="yt-uix-button-menu-item upload-menu-link"><img class="upload-menu-analytics" src="//s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif">Analytics</a></li></ul>
